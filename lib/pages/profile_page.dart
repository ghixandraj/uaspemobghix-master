...
import 'package:main/components/button.dart';
import 'package:main/components/textbox.dart';
...
void deleteAccountConfirmation(BuildContext context) async {
  bool confirm = false;
  await showDialog(
    context: context,
    builder: (context) => AlertDialog(
      ...
      actions: [
        ...
        TextButton(
          ...
          onPressed: () {
            confirm = true;
            // Balik ke laman login setelah berhasil menghapus akun
  ...
  if (confirm) {
    try {
      // Dapetin informasi user yang lagi login
      User? user = FirebaseAuth.instance.currentUser;

      if (user != null) {
        // Mengambil informasi email user yang lagi login
        String userEmail = user.email ?? '';

        // Logout user
        await FirebaseAuth.instance.signOut();

        // Hapus akun user dari Authentication
        await user.delete();
